...
$(document).ready(function() {
 ...
 $('.edit').editable('jeditable.php',{
     data   : "{'unknown':'不明','scholarship':'學術關係','friendship':'朋友關係', 'politics':'政治關係','writing':'著述關係', 'military':'軍事關係', 'medicine':'醫療關係','religion':'宗教關係', 'family':'家庭關係', 'finance':'財務關係',}",
     type   : 'select',
     submit : 'OK'
     });  
});
...
$chapter = '<a href="index.php?social_network2_id='.$id . '" target="_blank">' . $chapter . '</a>';
	...
	echo '<td class="top aligned jedit" title="' . $ori_targetname . '">' . $targetname . '</td>';
	//echo '<td>' . $social_network2->id . '</td>';
